          ...
          for(let i=0;i<visitor.confs.length;i++){
            if(visitor.confs[i].confId===confid){
              ...
              Visitor.aggregate([
                ...
                { $project : {linkedin:"$linkedin",profilePic:"$profilePic",matching:null,visitorfirstname:"$name.first_name",visitorlastname:"$name.last_name" ,confId : '$confs.confId', confName : '$confs.confname', profilePie : '$confs.profile_pie' } }
                ], function(err, result) {
